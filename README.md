...
4. **[AIOS_Issues.md](AIOS_Issues.md)** — the build broken into GitHub-ready issues, mapped to the build order.
5. `AIOS_prototype.html` — rough UI canvas (to be reshaped to the settled spec).
